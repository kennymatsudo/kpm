...
export interface SettingsTabDef {
  ...
  /** Only shown while a project is open. */
  requiresProject?: boolean;
  /** Panel manages its own padding, so the content area supplies none. */
  noPadding?: boolean;
  render: (ctx: SettingsTabContext) => React.ReactNode;
}

/**
 * The settings tabs, in display order. The single owner of tab identity: the
 * sidebar nav, the content area, keyboard navigation, and padding all read
 * from this list, so a tab cannot exist in one place and be missing in another.
 */
export const SETTINGS_TABS: SettingsTabDef[] = [
  ...
  },
  {
    ...
    render: ({ currentProjectId }) => <WorkflowSettings currentProjectId={currentProjectId} />,
  },
  {
    id: 'shortcuts',
  ...
  },
  {
    ...
    render: ({ currentProjectId }) => <McpServersSettings currentProjectId={currentProjectId} />,
  },
  {
    id: 'permissions',
    label: 'Writes',
